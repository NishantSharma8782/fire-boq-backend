...
def generate_pdf(project: dict, building_data: dict, recommendations: dict, boq_sections: list, standard: str = "NBC") -> bytes:
    ...
    std_notes   = "NFPA 72, NFPA 13, NFPA 14, NFPA 10" if standard.upper() == "NFPA" else "NBC 2016 Part 4, IS 2189:2008, IS 15105:2002, IS 3844:1989, IS 2190:2010"
    buffer = io.BytesIO()
    ...
    info_data = [
        ...
        ["Generated On", datetime.now().strftime("%d-%m-%Y %H:%M"), "Standard", std_display],
    ]
